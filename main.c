...
int main()
{
    ...
    while(input!=pin){
            count--;
            if(count==0){
                    printf("Congratulations\nnow you have no attempt left\n See ya next time\n bye......");
                return 0;}
           printf("Incorrect pin, try again (%d attemp left)\n",count);
        scanf("%d",&input);
...
int menu(){
    ...
    case '1':
        calender();
        printf("\nInput 1 for menu or 2 for exit\n");
        getch();
        goto top;
        break;
    case '2':
...
int calender()
{
    ...
    int i,j,totalDays,weekDay=0,spaceCounter=0,year=t.wYear;
...
{
    char choise;
    printf("\n\n\t\t1. Inch To Centimitre\n\n\t\t2. Celcious To Farenhite\n\n\t\t3. Kilomitre per hour to Mile per hour\n\n\t\t4. Back\n\n");
    choise=getch();
    if(choise=='1')
        inchtocm();
    else if(choise=='2')
...
int inchtocm()
{
    ...
    scanf("%f", &inch);
    cm = inch * 2.54;
    printf("\n\n\t\tEquivalent length in Centimeters = %0.2f", cm);
    getch();
    converter();
}
int celcioustofer()
